...
def ask_whatsapp_rag(user_query : str) ->str:
    ...
    prompt = f"""i have given you a list: {context_text} give answer according to: {user_query} if information is not available in the list say 'info not available' do not add additional information.translate {context_text} into actual marathi not english written"""
